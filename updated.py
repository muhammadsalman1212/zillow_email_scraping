...
# API request setup
    ...
    # i want to add page according to for loop
    payload = {
        "searchQueryState": {
    ...
    with open(csv_file, mode='a+', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["Detail URL", "Address", "Price", "Beds", "Baths", "Agent Phone Number", "Agent Name", "Area", "Broker Name"])
        for row in zip(detail_urls, all_address, price, beds, baths, AGENT_PH_NUMBER, AGENT_NAME, area, brokerName):
            writer.writerow(row)
